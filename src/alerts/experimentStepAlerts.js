...
export const EXPERIMENT_ALERTS = {
  ...
  sufficientData: {
    ...
    description: 'Now you can plot the graph by clicking on the graph button or add more readings to the table.',
    icon: '✅',
    stepNumber: 7,
    target: '#plot-button',
    title: 'You have added six readings.',
    type: 'success',
  },
  tenReadingsRecorded: {
    audio: ALERT_AUDIO.tenReadingsAdded,
    description: 'Now plot the graph and then click on the generate report button to generate your report.',
    icon: 'OK',
    stepNumber: 7,
    target: '#plot-button',
    title: 'All ten readings have been recorded.',
    type: 'success',
  },
  maxReadingsReached: {
    audio: ALERT_AUDIO.maxReadings,
    description: 'Now, click the Graph button.',
    icon: '!',
    stepNumber: 7,
    target: '#plot-button',
    title: 'You can add a maximum of ten readings to the table.',
    type: 'warning',
  },
  comparingValues: {
  ...
  insufficientGraphReadings: {
    audio: ALERT_AUDIO.insufficientReadings,
    description: 'Please add at least six readings to plot the graph.',
    icon: '❌',
    stepNumber: 9,
    target: '#observation-table-panel',
